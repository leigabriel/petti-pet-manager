...
import { pawOutline, refreshOutline } from "ionicons/icons";
    ...
    return (
        <AppShell title="Pets">
            <section className="mx-auto font-[IoskeleyMono,Space_Mono,Menlo,Monaco,Consolas,monospace] w-full max-w-140">
                <div className="my-3.5 mb-6.5">
                    <p className="m-0 text-[10px] font-bold tracking-[.15em] text-[#6e6e83] uppercase">
                        Your records
                    </p>
